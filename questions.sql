...
select department , COUNT(department) AS cntdept from worker group by department having cntdept <4;

-- Q-41. Write an SQL query to show all departments along with the number of people in there.

SELECT department , count(worker_id) AS totalppl from worker group by department;
